...
function clauses(message) {
    if (lowmessage.indexOf(",clause") == 0) {
        ...
        var theMessage = new Discord.RichEmbed().setTitle("Battle Types and Rules:");
        ...
        if (lowmessage.indexOf("inverse") != -1) { message.channel.send(theMessage.addField("Inverse Battle:", "Type effectiveness is reversed for the battle. 4x becomes 1/4x, 2x becomes 1/2x and vice versa. Immunities are treated as 2x super effective (the other type still applies, if there is one).\n*Not a valid rule for gym battles.*"); }
